...
<!-- SIGNATURE: sha256:c40eda4dfc99a0d63abe70ee6973f7b18eafe84719291aec03d4799078298850 -->
...
Skip linting for compiled skills (detected by `.skillc/manifest.json`).
...
This clause describes planned future extensions. These are NOT part of v0.1.0.
...
- SKL204: `code-block-language` — code blocks should have language tags
- SKL205: `heading-hierarchy` — no skipped heading levels
- SKL206: `line-length` — lines should not exceed threshold

**Note:** These extensions are documented for planning. They are out of scope for v0.1.0.
